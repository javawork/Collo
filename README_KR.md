...
저희 회사([LnK](http://www.logickorea.co.kr/))에서 DW와 통계 시스템을 구축할 때, 여러 팀에서 사용하는 DB, File 등에 기록된 다양한 포멧의 데이터를 Elasticsearch와 MySql로 통합하기 위해 Javascript로 제작된 작은 코드로 제작되었으며, 현재는 보다 다양한 저장소의 데이터를 가져오고 저장할 수 있도록 개선되었습니다. 
